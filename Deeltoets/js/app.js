...
function jsonData() {
    ...
    this.schedule_title = ko.observable("Bert");

    this.schedule = [

        schedule_title1: 'Pool A - Schedule',
        schedule_description: 'This is the schedule.',
        schedule_items: [
    ...
    this.game = [
            ...
            game_title: 'Game',
        game_description: 'This is the game.',
    ...
    game_items: [
        ...
        this.ranking = [
                ...
                ranking_title: 'Pool A - Ranking',
        ranking_description: 'This is the ranking.',
        ranking_items: [
